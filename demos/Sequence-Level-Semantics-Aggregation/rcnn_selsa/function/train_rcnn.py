...
def train_rcnn(cfg, dataset, image_set, root_path, dataset_path,
    ...
    # infer max shape
    max_data_shape = [('data', (cfg.TRAIN.BATCH_IMAGES, 3, max([v[0] for v in cfg.SCALES]),
    ...
    lr_scheduler = WarmupMultiFactorScheduler(lr_iters, lr_factor, cfg.TRAIN.warmup,
                                              cfg.TRAIN.warmup_lr, cfg.TRAIN.warmup_step)
    # optimizer
