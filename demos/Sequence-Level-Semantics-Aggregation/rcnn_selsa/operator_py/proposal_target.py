...
class ProposalTargetOperator(mx.operator.CustomOp):
    def __init__(self, num_classes, batch_images, batch_rois, cfg, fg_fraction, append_gt, output_sort):
        ...
        self._append_gt = append_gt
        self._output_sort = output_sort
...
class ProposalTargetProp(mx.operator.CustomOpProp):
    def __init__(self, num_classes, batch_images, batch_rois, cfg, fg_fraction='0.25', append_gt='True', output_sort='False'):
        ...
        self._append_gt = strtobool(append_gt)
        self._output_sort = strtobool(output_sort)
    ...
    def create_operator(self, ctx, shapes, dtypes):
        return ProposalTargetOperator(self._num_classes, self._batch_images, self._batch_rois, self._cfg,
                                      self._fg_fraction, self._append_gt, self._output_sort)
