...
if __name__ == '__main__':
	...
	repp = REPP(**repp_params, annotations_filename=annotations_filename,
	...
	with open(annotations_filename, 'r') as f: annotations = sorted(f.read().splitlines())
	print(' * Applying repp')
	...
	if args.evaluate:
		...
		stats = get_motion_mAP(annotations_filename, predictions_file_out + '_imdb.txt', stats_file_motion,
